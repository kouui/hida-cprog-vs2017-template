...
#define IDL_A_CALLBACK_OFFSET   32	/* If array has a "free_cb" callback,
		   then pass the "offset" field into the callback. This provides
		   a way to set and pass callback "data" without modifying
		   the IDL_ARRAY structure or breaking backwards compatibility
		   with the free_cb function prototype. If the flag is set,
		   then free_cb should have the form:
		   typedef void (* IDL_ARRAY_FREE_CB) (UCHAR *, IDL_FILEINT);   */
...
#define IDL_VENDOR_NAME "Exelis Visual Information Solutions, Inc., a subsidiary of Harris Corporation."
...
#define IDL_VERSION_SUB_DIRDIGIT	  0
  ...
  */
   ...
   */
#define IDL_VERSION_STRING "8.5.1"
#define IDL_VERSION_STRING_COPY "8.5.1"
#define IDL_VERSION_STRING_NOSUBMINOR "8.5"
...
#ifndef ptr_IDL_DEF
#define ptr_IDL_DEF
#define IDL_HV_F_STATIC	1024   /* This is a static class instance. */
...
#define ztimer_IDL_DEF
	...
	extern int IDL_CDECL IDL_AddSystemRoutine(IDL_SYSFUN_DEF *defs, int
		is_function, int cnt);
	extern void IDL_CDECL IDL_StrUpCase(IDL_REGISTER char *dest, IDL_REGISTER
		char *src);
	extern void IDL_CDECL IDL_StrDownCase(IDL_REGISTER char *dest,
		IDL_REGISTER char *src);
	...
	extern IDL_VPTR IDL_CDECL IDL_GettmpNULL();
	...
	extern IDL_VPTR IDL_CDECL IDL_scope_varfetch(int argc, IDL_VPTR *argv,
		char *argk);
	...
	extern void IDL_CDECL IDL_HeapDecrRefCount(IDL_HVID *hvid, IDL_MEMINT n);
	extern int IDL_CDECL IDL_ObjCallMethodByString(char *methName, IDL_HVID
		obj, IDL_VPTR *result, int argc, IDL_VPTR *argv, char *argk);
	extern IDL_HEAP_VPTR IDL_CDECL IDL_ObjNewCreateBaseVar(IDL_VPTR
		classname_v);
	extern IDL_VPTR IDL_CDECL IDL_ObjNew(int argc, IDL_VPTR *argv, char *argk);
	extern IDL_VPTR IDL_CDECL IDL_ObjIsA(int argc, IDL_VPTR argv[]);
